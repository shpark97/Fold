...
from .fold_postprocessor import FoldPostprocessor
from .fold_react_postprocessor import FoldReActPostprocessor
from .fold_ash_postprocessor import FoldASHPostprocessor
from .autofold_postprocessor import AutoFoldPostprocessor
from .autofold_react_postprocessor import AutoFoldReActPostprocessor
from .autofold_ash_postprocessor import AutoFoldASHPostprocessor
...
def get_postprocessor(config: Config):
    postprocessors = {
        ...
        'fold': FoldPostprocessor,
        'fold_react': FoldReActPostprocessor,
        'fold_ash': FoldASHPostprocessor,
        'autofold': AutoFoldPostprocessor,
        'autofold_react': AutoFoldReActPostprocessor,
        'autofold_ash': AutoFoldASHPostprocessor,
    }
